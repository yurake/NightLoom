...
Object.defineProperty(HTMLElement.prototype, 'focus', {
  ...
  value: jest.fn().mockImplementation(function(this: HTMLElement) {
    // Simulate focus by setting the activeElement
...
// Enhanced Element.scrollIntoView mock
Object.defineProperty(Element.prototype, 'scrollIntoView', {
  writable: true,
  value: jest.fn().mockImplementation(function(this: Element, options?: any) {
    // Mock implementation that does nothing but can be tracked
